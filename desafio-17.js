(function() {
  ...
  */
  ...
  no console:
  */
  text = text.replace(/Manuel Marques de Sousa/, 'Eduardo Felipe Rodrigues')
  ...
  */
  text = text.replace(/brasileiro/, 'piraiense')
  ...
  */
  ...
  console.log(`O mês de Março é representado pelo numero ${getMonthNumber('marco')}`)
  ...
  */
  ...
  console o resultado.
 */
  function replaceDate( regex1, regex2, day, month, year) {
