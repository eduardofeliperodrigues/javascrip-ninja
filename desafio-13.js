(function () {
  ...
  */
  let sul = ['Santa Catarina', 'Parana','Rio Grande do Sul'], sudeste =['Rio de Janeiro', 'São Paulo', 'Espirito Santo', 'Minas Gerais'];
  ...
  */
  brasil.splice(0, 0, 'Amazonas', 'Acre', 'Pará')
  ...
  */
  let nordeste = ['Piaui', 'Teresina', 'Ceara', 'Fortaleza'];
  ...
  */
  ...
  chamada `newSudeste`.
  */
  let newSudeste = brasil.splice(5, 5);
  ...
  */
  let maiorSete = brasil.every((item) => {
  ...
  */
  let filter = newBrasil.filter((item) => {
    return item.id % 2 === 0;
  })
