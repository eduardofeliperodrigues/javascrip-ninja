(function(window, document) {
  ...
  */
  ...
  console.log(sum(1, 2, 3, 4, 5, 6, 12, 13, 13, 23, 34, 54, 65));
  ...
  */
  let userEntry = prompt('Entre com alguns numeros que serão somados:');
  ...
  */
  ...
  // let numbers = justNumbers(userEntry).split("");
  console.log(numbers)
