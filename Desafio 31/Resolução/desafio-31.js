   ...
   $button.addEventListener('click', carRegistration, false);
    ...
    function reloadPage() {
      ...
      for (let vehicle in catalog) {
        ...
        $deleteBtn.setAttribute('data-js', 'deleteButton');
        let $tableDataText = document.createTextNode('Delete');
        $deleteBtn.appendChild($tableDataText);
    ...
    function buttonDelete() {
      let $buttonDelete = document.querySelectorAll('[data-js="deleteButton"]');
      
      Array.prototype.forEach.call($buttonDelete, item => {
